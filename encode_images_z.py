...
image_folder = './experiments/reconstruction/images/'

image_output_folder = './experiments/reconstruction/L2_z_images/'
latent_output_folder = './experiments/reconstruction/L2_z/'
